  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://mern-todo-pslr.onrender.com/api/v1/user/login",
        { email, password },
      ...
      login(res.data.token); // ✅ Update global auth context
        ...
        <div className="bg-white rounded-2xl shadow-xl border-0 overflow-hidden">
          ...
          <div className="px-8 py-6">
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 font-medium"
              >
